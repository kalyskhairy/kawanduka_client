<template lang="html">
    <div class="ps-product__info">
        ...
        <h4 v-if="product.publishAt.Valid === true" class="ps-product__price sale">
            <del class="mr-2">  {{ $helper.convertCurrency(product.price) }}</del>
            {{ $helper.convertCurrency(product.price) }}
        </h4>

        <h4 v-else class="ps-product__price">{{ $helper.convertCurrency(product.price) }}</h4>
